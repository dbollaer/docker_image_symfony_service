...
ADD composer.json /opt/composer.json
RUN cd /opt && npm install && composer update

ENV NODE_PATH /opt 

RUN mkdir -p /var/www/symfony && cp -af /opt/node_modules /var/www/symfony && cp -af /opt/vendor  /var/www/symfony
